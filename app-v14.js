...
(function(){
  ...
  const billing=document.createElement('script');billing.src='billing-dashboard-v33.js?v=33';billing.dataset.cleanBillingDashboard='1';document.head.appendChild(billing);
})();
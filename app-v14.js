...
(function(){
  ...
  function loadPlanInvoiceSource(){
    if(document.querySelector('script[data-plan-invoice-source-v56]'))return;
    const source=document.createElement('script');source.src='billing-plan-source-v52.js?v=56';source.dataset.planInvoiceSourceV56='1';
  ...
  function loadPlanInvoiceBridge(){
    if(document.querySelector('script[data-plan-invoice-v53]')){loadPlanInvoiceSource();return;}
    const bridge=document.createElement('script');bridge.src='billing-plan-invoice-v51.js?v=53';bridge.dataset.planInvoiceV53='1';
    bridge.onload=loadPlanInvoiceSource;
    bridge.onerror=()=>console.error('[Dabster] Errore caricamento precompilazione Piano → Righe Offerta v53');document.head.appendChild(bridge);
  }
  ...
  core.onload=()=>{
    ...
    const billingEntry=document.createElement('script');billingEntry.src='billing-entry-v34.js?v=45';document.head.appendChild(billingEntry);

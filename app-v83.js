/* v83 - Standard runtime with authoritative Activity Domain and orphan-free Kanban. */
(function(){
  ...
  const preload=[
    ...
    ['app-v9.js','v=clean2'],['app-v10.js','v=clean2'],['app-v11.js','v=15'],['app-v12.js','v=16'],['app-v13.js','v=83-source']
  ];
  ...
  function loadPlanInvoiceSource(){loadScript('billing-plan-source-v52.js?v=83','plan-source-v83');}
  function loadPlanInvoiceBridge(){loadScript('billing-plan-invoice-v51.js?v=83','plan-invoice-v83',loadPlanInvoiceSource);}
  function loadBillingPlan(){loadScript('billing-plan-v47.js?v=83','billing-plan-v83',loadPlanInvoiceBridge);}
  function loadOfferFlow(){loadScript('offer-flow-v38.js?v=83','offer-flow-v83',loadBillingPlan);}
  function loadTrigger(){loadScript('billing-trigger-v82-loader.js?v=83','billing-trigger-v83');}
  function loadActivityDomain(){loadScript('activity-domain-v82.js?v=83','activity-domain-v83',loadTrigger);}

  function afterKanbanReady(attempt=0){
    if(window.DABSTER_APP_V13_V83_READY){
      loadScript('workspace-cleanup-v34.js?v=34','workspace-cleanup-v83');
      loadScript('billing-entry-v34.js?v=50','billing-entry-v83');
      loadActivityDomain();
  ...
  core.src='app-v13-v83-loader.js?v=83';core.dataset.cleanLegacyUi='1';core.onerror=revealFailsafe;

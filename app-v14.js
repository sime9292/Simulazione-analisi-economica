...
(function(){
  ...
  const billing=document.createElement('script');billing.src='billing-dashboard-v32.js?v=32';billing.dataset.cleanBillingDashboard='1';document.head.appendChild(billing);
})();
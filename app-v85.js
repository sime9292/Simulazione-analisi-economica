/* v85 - Standard runtime with orphan-free Activity Domain and synchronous activity->billing recalculation. */
(function(){
  ...
  const preload=[
    ...
    ['app-v9.js','v=clean2'],['app-v10.js','v=clean2'],['app-v11.js','v=15'],['app-v12.js','v=16'],['app-v13.js','v=85-source']
  ];
  ...
  function loadPlanInvoiceSource(){loadScript('billing-plan-source-v52.js?v=85','plan-source-v85');}
  function loadPlanInvoiceBridge(){loadScript('billing-plan-invoice-v51.js?v=85','plan-invoice-v85',loadPlanInvoiceSource);}
  function loadBillingPlan(){loadScript('billing-plan-v47.js?v=85','billing-plan-v85',loadPlanInvoiceBridge);}
  function loadOfferFlow(){loadScript('offer-flow-v38.js?v=85','offer-flow-v85',loadBillingPlan);}
  function loadTrigger(){loadScript('billing-trigger-v85-loader.js?v=85','billing-trigger-v85');}
  function loadActivityDomain(){
    ...
    loadScript('activity-domain-v84-loader.js?v=85','activity-domain-v85');
  }

  function afterKanbanReady(attempt=0){
    if(window.DABSTER_APP_V13_V83_READY){
      loadScript('workspace-cleanup-v34.js?v=34','workspace-cleanup-v85');
      loadScript('billing-entry-v34.js?v=50','billing-entry-v85');
      loadActivityDomain();
  ...
  core.src='app-v13-v83-loader.js?v=85';core.dataset.cleanLegacyUi='1';core.onerror=revealFailsafe;
